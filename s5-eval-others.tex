...
It is worth noting that 5 of the 10 false positives we found in our evalution were due to a limitation of our implementation. Currently, the source code analysis plugin for C does not handle preprocessor directives and macros. Consequently, it may yield an incorrect CST due to parsing problems.
...
%\label{sec:eval:js:c:limitations}
